...
if __name__ == "__main__":
    ...
    # print(car2) 기존의 코드.
    print(car1) # 교수님의 오타일 것 같아 car1으로 수정했습니다.
    print(car2)
    print("출차" if car1.is_out() else "주차중")
    print("출차" if car2.is_out() else "주차중")
    ...
    car1.intime -= datetime.timedelta(hours=10) # 입차시간 조정은 2 가 아닌 본인이 직접 정할 것
    car2.outtime += datetime.timedelta(hours=20) # 출차시간 조정은 4 가 아닌 본인이 직접 정할 것
    # 주차요금을 계산한다.
    # 시간당 1500 원으로 현재 주차요금을 계산해서 출력한다.
    # print("주차요금:" + str(car2.cal_price(1500)))# 기존의 코드.
    print("주차요금:" + str(car1.cal_price(1500))) # 교수님의 오타일 것 같아 car1으로 수정했습니다.
